...
if(isset($_POST['login_button'])) {
    // Get login type (student / admin) from the select box value
	...
	if($check_login_query == 1) {
        ...
        $login_type=='admin'?//redirect to login.php which is the main page or dashboard
			header("Location: admin-dashboard.php"):header("Location: student-dashboard.php");
		exit();
	}
	else {?>
